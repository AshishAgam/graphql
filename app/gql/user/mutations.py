...
from app.utils.utils import hash_password,get_authenticated_user,authd_user_same_as
...
class AddUser(Mutation):
    ...
    # define decorator for admin user
    # use it 
    #   @admin_user
    #   def mutate 
    #       pass
    ...
    def mutate(root,info,username,email,password,role):
        ...
        if user:
            raise GraphQLError("A user with the email already exists")
